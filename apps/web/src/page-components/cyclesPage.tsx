...
import { CycleCard } from '@/components/cycles/card';
...
export default function TrainingTimeline() {
        ...
        switch (type) {
            ...
            case 'maintenance':
                return {
                    ...
                    timeline: 'bg-[#FF9800]',
                    accent: 'bg-[#FF9800]',
                    badgeBorder: 'border-[#FF9800]',
                    gradient: 'bg-gradient-to-br from-[#FF9800]/10 to-transparent',
                    shadow: 'hover:shadow-none',
                };
            case 'strength':
                return {
    ...
    const legendItems = [
        ...
        { type: 'maintenance', label: 'Maintenance', bg: 'bg-[#FF9800]' },
    ];
